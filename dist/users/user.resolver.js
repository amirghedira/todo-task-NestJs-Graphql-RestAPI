...
let UserResolver = class UserResolver {
    ...
    updateUserPassword(updatePasswordInput, user) {
...
__decorate([
    common_1.UseGuards(gql_auth_gard_1.GqlAuthGuard),
    graphql_1.Mutation(() => user_type_1.UserType),
    __param(0, graphql_1.Args('UpdateUserInput')), __param(1, currentuser_decorator_1.CurrentUser()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_input_1.UpdateUserInput, Object]),
    __metadata("design:returntype", void 0)
], UserResolver.prototype, "updateUser", null);
__decorate([
    common_1.UseGuards(gql_auth_gard_1.GqlAuthGuard),
    graphql_1.Mutation(() => user_type_1.UserType),
    __param(0, graphql_1.Args('UpdatePasswordInput')), __param(1, currentuser_decorator_1.CurrentUser()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [user_input_1.UpdatePasswordInput, Object]),
    __metadata("design:returntype", void 0)
], UserResolver.prototype, "updateUserPassword", null);
__decorate([
    common_1.UseGuards(gql_auth_gard_1.GqlAuthGuard),
    graphql_1.Mutation(() => user_type_1.UserType),
    __param(0, graphql_1.Args('userid')), __param(1, currentuser_decorator_1.CurrentUser()),
    __metadata("design:type", Function),
